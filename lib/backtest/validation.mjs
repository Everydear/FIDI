...
export function buildValidationGuide({
  ...
  const checks = [
    ...
    },
    {
      ...
      guide: "동일위험 기준선과의 차이는 성과 참고자료로 사용합니다.",
    },
    {
      id: "cost-stress",
      label: "거래비용 3배 스트레스",
    ...
    {
      id: "forward-oos",
      label: "규칙 확정 후 1년 전진 OOS",
      status: "IN_PROGRESS",
      detail: "미래 데이터 관찰 시작 2026-07-25 · 2027-07-25에 1년 결과 확인",
      guide: "OOS는 규칙을 고정한 채 미래 데이터에서 신호가 어떻게 작동하는지 기록하는 과정입니다.",
    },
    {
      ...
      guide: "처음에는 자동주문 없이 수량과 예상 체결가격을 확인한 뒤 승인합니다.",
    },
  ];
